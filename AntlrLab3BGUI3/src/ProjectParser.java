// $ANTLR 3.4 D:\\Compiler\\Project.g 2024-05-14 17:43:49
...
public TreeAdaptor getTreeAdaptor() {
    ...
    public final ProjectParser.classDec_return classDec() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: Class, 78, 79, VAR, stmt, Modifier, main
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final ProjectParser.main_return main() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: 51, 73, VOID, STRING, 67, Modifier, 79, 78, 76, 50, stmt, VAR
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
        ...
        try {
            ...
            switch (alt97) {
                ...
                case 7 :
                    ...
                    // AST REWRITE
                    // elements: 51, generalArithExpr, 50
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
                ...
                case 8 :
                    ...
                    // AST REWRITE
                    // elements: Fun, 50, 51, generalArithExpr
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
