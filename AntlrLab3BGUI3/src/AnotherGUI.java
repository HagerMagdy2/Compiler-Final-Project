...
public class AnotherGUI extends javax.swing.JFrame {
   ...
   ProjectParser parser;
    ...
    public CustomFileChooser() {
        super();
        // Customize your file chooser here
        // For example:
    ...
    // Override other methods as needed for further customization
}
...
// Invoke the program rule in get return value
            ProjectParser.startgeneralArithExpr_return r = parser.startgeneralArithExpr();
...
//            stt = stt.replaceFirst("style=\"bold\"", "style=\"regular\"");
            ...
            String msg = parser.s;
            Errors.setForeground (Color.red);
            Errors.setText("Error: \n" + e.getMessage() + "\n" + msg); Check.setIcon (new ImageIcon ("False.JPG"));
            ParseTree.setIcon (null);
            ParseTree.setText (null);
        }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        // Set the default directory to your project directory
        String projectDirectory = System.getProperty("user.dir");
        jFileChooser1.setCurrentDirectory(new File(projectDirectory));

        // Customize the dialog appearance
        jFileChooser1.setDialogTitle("Select a File"); // Set the dialog title
        jFileChooser1.setApproveButtonText("Open"); // Set the button text
        jFileChooser1.setFileSelectionMode(JFileChooser.FILES_ONLY); // Restrict selection to files only
  ...
  try {
        ...
        // Set the default close operation for the image frame
        imageFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        // Create a JLabel to display the image
        JLabel imageLabel = new JLabel(new ImageIcon(image));
        // Add the image label to the image frame
